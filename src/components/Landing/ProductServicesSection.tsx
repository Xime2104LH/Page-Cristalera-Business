...
const ProductServicesSection = () => { 
  return (
    <div className="text-center p-8 md:pt-20 lg:px-28 lg:py-16">
      <HeaderSections 
        wordKey='Nuestros productos' 
        title='Catálogo de productos y servicios'
        description='Descubre nuestra amplia gama de productos diseñados para transformar y mejorar cada espacio de tu hogar.'
      />
